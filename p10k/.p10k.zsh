# Generated by Powerlevel10k configuration wizard on 2026-05-02 at 18:26 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR="%F{${P10K_COLOR_OVERLAY0}}\uE0B1"
  # Separator between same-color segments on the right.
  #typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%244F\uE0B3'
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR="%F{${P10K_COLOR_OVERLAY0}}\uE0B3"
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta="%F{${P10K_COLOR_MAUVE}}"  # default foreground
      local      clean="%F{${P10K_COLOR_MAUVE}}"  # green foreground
      local   modified="%F{${P10K_COLOR_YELLOW}}" # yellow foreground
      local  untracked="%F{${P10K_COLOR_BLUE}}"   # blue foreground
      local conflicted="%F{${P10K_COLOR_RED}}"    # red foreground
    else
      # Styling for incomplete and stale Git status.
      ...
      local       meta="%F{${P10K_COLOR_OVERLAY2}}" # grey foreground
      local      clean="%F{${P10K_COLOR_OVERLAY2}}" # grey foreground
      local   modified="%F{${P10K_COLOR_OVERLAY2}}" # grey foreground
      local  untracked="%F{${P10K_COLOR_OVERLAY2}}" # grey foreground
      local conflicted="%F{${P10K_COLOR_OVERLAY2}}" # grey foreground
    fi
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$P10K_COLOR_LAVENDER
